...
public class MyDrawer extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            MyProfil profil = new MyProfil();
            FragmentManager fragmentManager = getSupportFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.myLayout, profil).commit();

        } else if (id == R.id.exit) {
            Intent intent = new Intent(MyDrawer.this, MainActivity.class);
